...
setting.api.SCOPE = 'r:auth:emailAddress,rw:auth:backupEmailAddress,*r:auth:userName,*r:$CLIENT_ID:serviceUserId,*rw:$CLIENT_ID:notification,rw:$CLIENT_ID:json_v1,rw:auth:chatgpt'
